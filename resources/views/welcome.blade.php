        ...
        <div class="min-h-screen font-sans antialiased relative">
            <div class="relative">
                <div class="absolute top-0 left-0 w-full h-[130vh] sm:h-[225vh] md:h-[100vh] lg:h-[100vh] bg-cover"
                    style="background-image: url({{env('APP_URL')}}{{$information->image}});">
                </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col lg:flex-row items-center space-x-4 xl:space-x-8">
                            <div class="w-full flex flex-row items-center justify-between py-6">
                                <div><a href="{{url('/')}}"><img src="{{env('APP_URL')}}{{$information->logo_header}}"
                    ...
                    <div class="w-full"="">
                        ...
                        <section
                            ...
                            <div id="portfolio-home"
                                ...
                                <div
                                    class="group portfolio-item {{ $item->jenis_tag_id == 1 ? 'logo' : ($item->jenis_tag_id == 2 ? 'website' : '') }} relative sm:w-1/3 overflow-hidden space-y-6 lg:px-8 px-6 lg:py-8 aos-init">
                                    <img src="{{env('APP_URL')}}{{$item->image}}" class="img-fluid object-cover w-full"
                                        alt="">
                                    <div
                        ...
                        <section class="w-full my-10"
                            style="background-image: url({{env('APP_URL')}}{{$information->image}});background-size: cover;">
                            <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div data-aos="fade-down-right" data-aos-duration="1000"
                                        ...
                                        <img src="{{ asset('assets/img/default-superior-1.png') }}" class="img-fluid"
                                            alt="">
                                    ...
                                    <div data-aos="fade-down-right" data-aos-duration="1000"
                                        class="relative sm:w-1/2 overflow-hidden space-y-6 lg:px-8 px-6 lg:py-8 aos-init">
                                        <img src="{{ asset('assets/img/default-superior-2.png') }}" class="img-fluid"
                                            alt="">
                                    ...
                                    <div data-aos="fade-up-right" data-aos-duration="1000"
                                        class="relative sm:w-1/2 overflow-hidden space-y-6 lg:px-8 px-6 lg:py-8 aos-init">
                                        <img src="{{ asset('assets/img/default-superior-3.png') }}" class="img-fluid"
                                            alt="">
                                    ...
                                    <div data-aos="fade-up-right" data-aos-duration="1000"
                                        class="relative sm:w-1/2 overflow-hidden space-y-6 lg:px-8 px-6 lg:py-8 aos-init">
                                        <img src="{{ asset('assets/img/default-superior-4.png') }}" class="img-fluid"
                                            alt="">
                            ...
                            <div class="w-full lg:w-3/12 px-4">
                                <div
                                    ...
                                    <div class="w-full place-self-center"=""><img data-aos="fade-up"
                                            data-aos-once="true" src="{{env('APP_URL')}}{{$information->logo_header}}"
                                            alt="" class="-mt-30 aos-init aos-animate"="">
                                    </div>
                                    <div class="mt-7">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="flex items-center lg:justify-end">
                                                <i class="fab fa-whatsapp text-white text-2xl mr-2"
                                                    aria-hidden="true"></i>
                                                <a target="_blank"
                                                    class="text-white hover:text-blueGray-800 font-bold block pb-2 text-xl lg:text-right"
                                            ...
                                            <li class="flex items-center lg:justify-end lg:mt-20">
                                                <a class="font-bold text-white block pb-2 text-xl lg:text-right"
                                                    href="{{$information->google_map}}" target="_blank">
                                                    {{$information->address}}
                                                </a>
                                            </li>
                                        </ul>
