...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-M88V6R8K');
    </script>
...
<body class="bg-white">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M88V6R8K" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div id="__layout">
        <div class="min-h-screen font-sans antialiased relative">
            <div class="relative">
                ...
                <nav class="hover:shadow-xl fixed z-10 w-full text-neutral-800 bg-black shadow-2xl hover:bg-[#181818] duration-500">
                    <div class="flex flex-col max-w-screen-xl px-8 mx-auto lg:items-center lg:justify-between lg:flex-row py-4">
                        <div class="flex flex-col lg:flex-row items-center space-x-4 xl:space-x-8">
                            <div class="w-full flex flex-row items-center justify-between py-6">
                                <div><a href="{{url('/')}}"><img src="{{ asset('assets/img/logo.png') }}" alt="Nefa Logo" class="w-24 xl:w-28"></a>
                                </div>
                                <div class="lg:hidden">
                        ...
                        <div class="space-x-3 hidden lg:flex">
                            <ul class="menu w-full h-auto flex flex-col flex-grow lg:items-center pb-4 lg:pb-0 lg:justify-end lg:flex-row origin-top duration-300 xl:space-x-2 space-y-3 lg:space-y-0 hidden lg:flex">
                ...
                <div class="fixed bottom-20 right-10 z-10">
                    <a title="Chat Whatsapp" href="{{$information->link_wa}}" target="_blank" class="block rounded-full transition-all shadow transform hover:scale-110 hover:rotate-12">
                        <img class="object-cover object-center lg:w-36 lg:h-36 w-16 h-16" src="{{ asset('assets/img/order.png') }}" alt="Saya mau pesan">
                    </a>
                </div>
                        ...
                        <div class="flex flex-wrap text-left lg:text-left place-content-center">
                            <div class="w-full lg:w-3/12 px-4">
                                <div class="hidden sm:block col-span-12 mt-12 mb-12 lg:mt-20 lg:col-span-6 place-self-center"="">
                                    <div class="w-full place-self-center"=""><img data-aos="fade-up" data-aos-once="true" src="{{ asset('assets/img/logo.png') }}" alt="" class="-mt-30 aos-init aos-animate"="">
                                    </div>
                                    <div class="mt-7">
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <ul class="list-unstyled">
                                            <li class="flex items-center lg:justify-end">
                                                ...
                                                <a class="text-white hover:text-blueGray-800 font-bold block pb-2 text-xl lg:text-right" target="_blank" href="{{$information->link_wa}}">{{$information->phone}}</a>
                                            </li>
                                            <li class="flex items-center lg:justify-end">
                                                <i class="fab fa-instagram text-white text-2xl mr-2"></i>
                                                <a class="text-white hover:text-blueGray-800 font-bold block pb-2 text-xl lg:text-right" href="{{ $information->instagram}}" target="_blank">studiodesign1017</a>
                                            </li>
                                            <li class="flex items-center lg:justify-end lg:mt-20">
                                                <a class="font-bold text-white block pb-2 text-xl lg:text-right" href="https://goo.gl/maps/your-location" target="_blank">
                                                    {{ $information->address }}
                                                </a>
                                            </li>
                                        </ul>
